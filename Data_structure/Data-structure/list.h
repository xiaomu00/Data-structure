...
////////////////////////////////////////////////////////////////////////
////单链表的函数接口声明
static DCListNode* BuyDCNode(ElemType x);//开辟一个节点空间并赋值
void DCListInit(DCList *pst);//单链表序表初始化函数声明
void DCListPushBack(DCList *plist, ElemType x);//尾部插入
void DCListPushFront(DCList *plist, ElemType x);//头部插入
...
//开辟一个节点空间并赋值
static DCListNode* BuyDCNode(ElemType x)
{
